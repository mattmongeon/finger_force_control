...
std::vector<cElectrodeTdcCompensator> cFunctionFitNLS::TrainAgainstDataFiles(const std::vector<std::string>& files)
{
	...
	double d1[5] = {2818.41,1,1,1,1};

	double a2[5] = {526.548,0.1,1,1,1};
	double b2[5] = {-764.721,1,1,1,1};
	double c2[5] = {-0.00233386,1,1,1,1};
	double d2[5] = {3000.48,1,1,1,1};

	double a3[5] = {529.69,0.1,1,1,1};
	double b3[5] = {-766.768,1,1,1,1};
	double c3[5] = {-0.00268468,1,1,1,1};
	double d3[5] = {3001.55,1,1,1,1};

	double a4[5] = {670.453,0.1,1,1,1};
	double b4[5] = {-752.5,1,1,1,1};
	double c4[5] = {-0.00281257,1,1,1,1};
	double d4[5] = {2729.95,1,1,1,1};

	double a5[5] = {533.689,0.1,1,1,1};
	double b5[5] = {-791.039,1,1,1,1};
	double c5[5] = {-0.00269191,1,1,1,1};
	double d5[5] = {2995.86,1,1,1,1};

	double a6[5] = {691.525,0.1,1,1,1};
	double b6[5] = {-767.93,1,1,1,1};
	double c6[5] = {-0.00251413,1,1,1,1};
	double d6[5] = {2733.18,1,1,1,1};
	...
	double a11[5] = {476.722,0.1,1,1,1};
	double b11[5] = {-1091.05,1,1,1,1};
	double c11[5] = {-0.00152282,1,1,1,1};
	double d11[5] = {2681.74,1,1,1,1};
	...
	double a14[5] = {468.788,0.1,1,1,1};
	double b14[5] = {-871.769,1,1,1,1};
	double c14[5] = {-0.0029203,1,1,1,1};
	double d14[5] = {2864.39,1,1,1,1};
	...
	double a16[5] = {493.346,0.1,1,1,1};
	double b16[5] = {-883.858,1,1,1,1};
	double c16[5] = {-0.00269728,1,1,1,1};
	double d16[5] = {2865.7,1,1,1,1};

	double a17[5] = {650.0,0.1,1,1,1};
	double b17[5] = {-700.0,1,1,1,1};
	double c17[5] = {-0.0025,1,1,1,1};
	double d17[5] = {2800,1,1,1,1};

	double a18[5] = {650.0,0.1,1,1,1};
	double b18[5] = {-700.0,1,1,1,1};
	double c18[5] = {-0.0025,1,1,1,1};
	double d18[5] = {2800,1,1,1,1};

	double a19[5] = {650.0,0.1,1,1,1};
