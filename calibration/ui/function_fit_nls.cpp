...
std::vector<cElectrodeTdcCompensator> cFunctionFitNLS::TrainAgainstDataFiles(const std::vector<std::string>& files)
{
	...
	double a6[5] = {611,0.1,1,1,1};
	double b6[5] = {-756,1,1,1,1};
	double c6[5] = {-0.002676917,1,1,1,1};
	double d6[5] = {2857.16,1,1,1,1};
	...
	double a16[5] = {559.022,0.1,1,1,1};
	double b16[5] = {-837.522,1,1,1,1};
	double c16[5] = {-0.00269729,1,1,1,1};
	double d16[5] = {2800.02,1,1,1,1};

	double a17[5] = {591.062,0.1,1,1,1};
	double b17[5] = {-735.791,1,1,1,1};
	double c17[5] = {-0.0021852,1,1,1,1};
	double d17[5] = {2884.2,1,1,1,1};

	double a18[5] = {610.0,0.1,1,1,1};
	double b18[5] = {-720.0,1,1,1,1};
	double c18[5] = {-0.002,1,1,1,1};
	double d18[5] = {2840.0,1,1,1,1};
